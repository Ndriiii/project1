                        ...
                        <li class="relative shrink-0">
                            ...
                            <div id="categoryDropdownMenu" class="hidden z-10 absolute left-0 top-full mt-2 w-48 divide-y divide-gray-100 rounded-lg bg-white shadow dark:divide-gray-600 dark:bg-gray-700">
                                <ul class="p-2 text-start text-sm font-medium text-gray-900 dark:text-white">
                                    <li><a href="#clothing" title="" class="dropdown-link block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">Clothing</a></li>
                                    <li><a href="#gaming" title="" class="dropdown-link block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">Gaming</a></li>
                                    <li><a href="#other" title="" class="dropdown-link block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">Others</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
                ...
                <div class="flex items-center space-x-8">
                    <ul class="hidden lg:flex items-center justify-start gap-6 md:gap-8 py-3 sm:justify-center">
                        ...
                        <li class="relative shrink-0">
                            ...
                            <div id="categoryDropdownMenu" class="hidden z-10 absolute left-0 top-full mt-2 w-48 divide-y divide-gray-100 rounded-lg bg-white shadow dark:divide-gray-600 dark:bg-gray-700">
                                <ul class="p-2 text-start text-sm font-medium text-gray-900 dark:text-white">
                                    <li><a href="#clothing" title="" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">Clothing</a></li>
                                    <li><a href="#gaming" title="" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">Gaming</a></li>
                                    <li><a href="#other" title="" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">Others</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
